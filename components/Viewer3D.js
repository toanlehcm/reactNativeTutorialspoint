...
var yourPictureRequireForderNoSame = require('../public/images/reactnative_tutoritalspoint.png');
...
var text = {
  ...
  case_3: "<Image id='img_3' source={{ uri: '../public/images/reactnative_tutoritalspoint.png' }} style={{ width: 40, height: 40 }} />",
...
const Viewer3D = () => (
  <View>
    ...
    <p>{text.case_3}</p>
    <Image id='img_3' source={{ uri: '../public/images/reactnative_tutoritalspoint.png' }} style={{ width: 40, height: 40 }} />
    <p>----</p>
